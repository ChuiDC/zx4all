...
!	mov.l zPC,ezPC_MEM
	...
	SAVE_REG(`r5')
	SAVE_REG(`r6')
	! this register needs to be saved to memory
	! in order to be accessed externally
	! by z80_stop_emulating
!	mov #(_z80_ICount - REF),DIRT_REG
!	add REF_REG,DIRT_REG
!	mov.l r7,@DIRT_REG
	SAVE_REG(`r7')
...
!	ifdef(`EMULATE_BITS_3_5',`RESTAURAR MACL')
	...
	! this register needs to be saved in memory
	! in order to be accessed externally
	! by z80_stop_emulating
!	mov #(_z80_ICount - REF),DIRT_REG
!	add REF_REG,DIRT_REG
