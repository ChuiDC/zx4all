...
case JR_NZ:   if(R->AF.B.l&Z_FLAG) R->PC.W++; else { R->ICount-=5;R->TStates+=5;M_JR; } break;
case JR_NC:   if(R->AF.B.l&C_FLAG) R->PC.W++; else { R->ICount-=5;R->TStates+=5;M_JR; } break;
case JR_Z:    if(R->AF.B.l&Z_FLAG) { R->ICount-=5;R->TStates+=5;M_JR; } else R->PC.W++; break;
case JR_C:    if(R->AF.B.l&C_FLAG) { R->ICount-=5;R->TStates+=5;M_JR; } else R->PC.W++; break;
...
case RET_NZ:  if(!(R->AF.B.l&Z_FLAG)) { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_NC:  if(!(R->AF.B.l&C_FLAG)) { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_PO:  if(!(R->AF.B.l&P_FLAG)) { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_P:   if(!(R->AF.B.l&S_FLAG)) { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_Z:   if(R->AF.B.l&Z_FLAG)    { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_C:   if(R->AF.B.l&C_FLAG)    { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_PE:  if(R->AF.B.l&P_FLAG)    { R->ICount-=6;R->TStates+=6;M_RET; } break;
case RET_M:   if(R->AF.B.l&S_FLAG)    { R->ICount-=6;R->TStates+=6;M_RET; } break;

case CALL_NZ: if(R->AF.B.l&Z_FLAG) R->PC.W+=2; else { R->ICount-=7;R->TStates+=7;M_CALL; } break;
case CALL_NC: if(R->AF.B.l&C_FLAG) R->PC.W+=2; else { R->ICount-=7;R->TStates+=7;M_CALL; } break;
case CALL_PO: if(R->AF.B.l&P_FLAG) R->PC.W+=2; else { R->ICount-=7;R->TStates+=7;M_CALL; } break;
case CALL_P:  if(R->AF.B.l&S_FLAG) R->PC.W+=2; else { R->ICount-=7;R->TStates+=7;M_CALL; } break;
case CALL_Z:  if(R->AF.B.l&Z_FLAG) { R->ICount-=7;R->TStates+=7;M_CALL; } else R->PC.W+=2; break;
case CALL_C:  if(R->AF.B.l&C_FLAG) { R->ICount-=7;R->TStates+=7;M_CALL; } else R->PC.W+=2; break;
case CALL_PE: if(R->AF.B.l&P_FLAG) { R->ICount-=7;R->TStates+=7;M_CALL; } else R->PC.W+=2; break;
case CALL_M:  if(R->AF.B.l&S_FLAG) { R->ICount-=7;R->TStates+=7;M_CALL; } else R->PC.W+=2; break;
...
#ifdef MASCARA_AF
case PUSH_AF:  M_PUSH((AF)&MASCARA_AF);break;
#else
...
#ifdef MASCARA_AF
case POP_AF:   M_POP((AF)&MASCARA_AF);break;
#else
case POP_AF:   M_POP(AF);break;
#endif

case DJNZ: if(--R->BC.B.h) { R->ICount-=5;R->TStates+=5;M_JR; } else R->PC.W++;break;
case JP:   M_JP;break;
case JR:   M_JR;break;
...
case NOP:  break;
case OUTA: I=RdZ80(R->PC.W++);OutZ80(((word)R->AF.B.h)*256+((word)I),R->AF.B.h);break;
case INA:  I=RdZ80(R->PC.W++);R->AF.B.h=InZ80(((word)R->AF.B.h)*256+((word)I));break;
