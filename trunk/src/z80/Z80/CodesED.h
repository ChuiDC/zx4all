...
case LD_A_R:  
  R->AF.B.h=((R->R & 0x7F) | (R->R2));// -R->ICount);
  R->AF.B.l=(R->AF.B.l&C_FLAG)|(R->IFF&IFF_2? P_FLAG:0)|ZSTable[R->AF.B.h];
  break;

case LD_I_A:   R->I=R->AF.B.h;break;
case LD_R_A:   R->R=(byte)(R->AF.B.h);R->R2=(byte)((R->AF.B.h) & 0x80);break;
...
case OUT_xC_B: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->BC.B.h);break;
case OUT_xC_C: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->BC.B.l);break;
case OUT_xC_D: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->DE.B.h);break;
case OUT_xC_E: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->DE.B.l);break;
case OUT_xC_H: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->HL.B.h);break;
case OUT_xC_L: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->HL.B.l);break;
case OUT_xC_A: OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),R->AF.B.h);break;

case INI:
  WrZ80(R->HL.W++,InZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h)));
  R->BC.B.h--;
...
case INIR:
  WrZ80(R->HL.W++,InZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h)));
  R->BC.B.h--;R->ICount-=21;R->TStates+=21;  
  if(R->BC.B.h)
	  { R->AF.B.l=N_FLAG;R->PC.W-=2; }
  else {
	  R->AF.B.l=Z_FLAG|N_FLAG;R->ICount+=5;R->TStates-=5; }
  break;
...
case OUTI:  
  I=RdZ80(R->HL.W++);
  OutZ80(((word)(R->BC.B.l))+256*((word)R->BC.B.h),I);
  R->BC.B.h--;
...
case CPIR:
  I=RdZ80(R->HL.W++);
  J.B.l=R->AF.B.h-I;
  R->BC.W--;R->ICount-=21;R->TStates+=21;

  R->AF.B.l =
    N_FLAG|(R->AF.B.l&C_FLAG)|ZSTable[J.B.l]|
    ((R->AF.B.h^I^J.B.l)&H_FLAG)|(R->BC.W? P_FLAG:0);
  if(R->BC.W&&J.B.l) R->PC.W-=2; else { R->ICount+=5;R->TStates-=5;}
  break;  
